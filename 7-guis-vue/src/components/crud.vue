    ...
    <div class="flex mb-4">
      ...
      <div class="w-2/3">
        <label class="block mb-2"
          >Nome: <input v-model="first" class="p-2 border rounded"
        /></label>
        <label class="block mb-2"
          >Sobrenome: <input v-model="last" class="p-2 border rounded"
        /></label>
      </div>
    </div>

    <div class="buttons">
      <button @click="create" class="bg-green-500 text-white px-4 py-2 rounded">
        Criar
      </button>
      <button
        @click="update"
      ...
      <button @click="del" class="bg-red-500 text-white px-4 py-2 rounded">
        Deletar
      </button>
    </div>
  </div>
